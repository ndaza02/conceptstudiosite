...
$(function () {
    ...
    ***************************/
    $('.mil-has-children > a').on('click', function (e) {
        // If the clicked link is not active (submenu closed), open it and prevent navigation.
        if (!$(this).hasClass('mil-active')) {
            e.preventDefault();
            $('.mil-has-children ul').removeClass('mil-active');
            $('.mil-has-children a').removeClass('mil-active');
            $(this).addClass('mil-active');
            $(this).next().addClass('mil-active');
        }
        // If it IS active, let the browser follow the link (second click).
    });
    /***************************
